...
//		Benchmark.loadNMatrixFromFile(file_m, NUM_FUNC, dimensions, dimensions, M);
		...
		hc = new F16(NUM_FUNC, dimensions, sigma, o, z, biases, lambda, M, w, zM);
	...
	private class F16 extends HybridComposition {
		...
		public F16(int numFunc, int dimensions, double[] sigma, double[][] o, double[][] z, double[] biases, double[] lambda, double[][][] M, double[] w, double[][] zM) {
