...
public class F15_HybridComposition_1 extends Function {
	...
	public F15_HybridComposition_1(int dimension, double bias) {
		...
		hc = new F15(NUM_FUNC, dimensions, lambda, biases, sigma, o, M, w, z, zM);
...
//	}
	...
	public class F15 extends HybridComposition {
		...
		// Estimate maximum for each function in the hybrid composition
