...
public class F22_RotatedHybridCompositionHighConditionNumMatrix_3 extends Func {
	...
	public F22_RotatedHybridCompositionHighConditionNumMatrix_3(int dimension, double bias) {
...
//		Benchmark.loadNMatrixFromFile(file_m, NUM_FUNC, dimensions, dimensions, M);
		...
		hc = new F22(NUM_FUNC, dimensions, lambda, biases, sigma, o, z, M, w, zM);
	...
	private class F22 extends HybridComposition {
		
		public F22(int numFunc, int dimensions, double[] lambda, double[] biases, double[] sigma, double[][] o, double[][] z, double[][][] M, double[] w, double[][] zM) {
